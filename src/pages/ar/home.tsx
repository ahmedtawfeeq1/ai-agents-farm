...
import { Search, ChevronUp, X, ArrowLeftCircle } from 'lucide-react';
            ...
            >
                ...
                <div className="container mx-auto px-4 py-12 text-center" dir="rtl">
                    <span className="inline-block px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold mb-4">
                        مزرعة وكلاء الذكاء الاصطناعي! 🤖
                    </span>
                    <h1 className="text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
                        اكتشف مساعد الذكاء الاصطناعي المثالي لك!
                    </h1>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        استكشف مجموعتنا المختارة من وكلاء الذكاء الاصطناعي وتدفقات الأتمتة المصممة لزيادة إنتاجيتك وتحسين مهامك اليومية.
                    </p>
                </div>
            </motion.div>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="text-center mb-12" dir="rtl">
                    <span className="inline-block px-4 py-2 bg-blue-100 text-blue-600 rounded-full text-sm font-semibold">
                        الركائز الثلاث لبرنامج تدريب وكلاء الذكاء الاصطناعي والأتمتة!
                    </span>
                </div>
                ...
                <motion.div
                    ...
                    className="container mx-auto grid md:grid-cols-3 gap-6 max-w-6xl px-4 mb-12" dir="rtl"
                >
                    <AgentTypeBlock
                        title="وكلاء المعرفة"
                        description="أدوات الذكاء الاصطناعي التي تجمع المعلومات وتحللها وتلخصها."
                        examples={['البحث والتحليل', 'إنشاء المحتوى', 'التخطيط الاستراتيجي']}
                        graphic={KnowledgeGraphic}
                        color="border-blue-600"
                    />
                    <AgentTypeBlock
                        title="وكلاء التنفيذ"
                        description="مساعدون يقومون بتنفيذ مهام محددة بناءً على محفزات معينة."
                        examples={['إدارة التقويم', 'مراقبة المهام', 'تتبع الأداء']}
                        graphic={ActionGraphic}
                        color="border-green-600"
                    />
                    <AgentTypeBlock
                        title="تدفقات الأتمتة"
                        description="حلول متكاملة لأتمتة العمليات من البداية إلى النهاية."
                        examples={['معالجة المستندات', 'تكامل متعدد القنوات', 'الأتمتة القائمة على الأحداث']}
